 ...
 */
//#define STARTUP_MESSAGE "Hello MIST Team!"
...
void loop() {
    ...
    sendVRms();//This is the function we call to send our packet
    delay(1000);
...
void sendVRms() {
    ...
    if (LMIC.opmode & (1 << 7)) {
        ...
        Serial.println("Something already in queue");
        return;
    }

    // Convert to a string
    //char buffer[11];//11 byte buffer
